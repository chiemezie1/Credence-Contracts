...
/// Tests for emergency_drain_to_treasury entrypoint.
#[cfg(test)]
...
pub enum DataKey {
    ...
    Paused,
    /// Whether a given address is a registered pause signer. Value: `bool`.
    PauseSigner(Address),
    /// Number of registered pause signers. Value: `u32`.
    PauseSignerCount,
    /// Required number of approvals to execute a pause proposal. Value: `u32`.
    PauseThreshold,
    /// Pending pause proposal action by proposal id. Value: `u32` (PauseAction).
    PauseProposal(u64),
    /// Approval count for a pause proposal. Value: `u32`.
    PauseApprovalCount(u64),
    /// Per-signer approval flag for a proposal. Value: `bool`.
